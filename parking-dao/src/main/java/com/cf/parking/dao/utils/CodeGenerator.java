package com.cf.parking.dao.utils;
...
public class CodeGenerator {
    ...
    public static final String[] tableArray = {"white_list"};
    public static final String[] tablePrefixArray = {""};
    public static final String packageName = "com.cf";
    public static final String moduleName = "parking";
...
//                .commentDate("yyyy-MM-dd") // 注释日期	默认值: yyyy-MM-dd
        ...
        PackageConfig.Builder packageConfig = new PackageConfig.Builder()
                ...
                .entity("parking-dao.src.main.java.com.cf.parking.dao.po") // Entity 包名	默认值:entity
                .service("parking-services.src.main.java.com.cf.parking.services.service") // Service 包名	默认值:service
                .mapper("parking-dao.src.main.java.com.cf.parking.dao.mapper") // Mapper 包名	默认值:mapper
                .xml("parking-dao.src.main.resources.mapping") // Mapper XML 包名	默认值:mapper.xml
                ;
